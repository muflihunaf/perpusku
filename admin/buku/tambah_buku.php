                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            <form action="" method="POST" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="" class="control-label col-sm-2">Penerbit</label>
                                    <div class="col-md-10">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-sm-2">Lokasi Buku</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group">
                                    <input type="submit" name="submit" value="Simpan"
                                        class="col-md-2 col-md-offset-10 bg-primary btn btn-primary">
                                </div>
                            </form>
                        </div>
                    </div>
