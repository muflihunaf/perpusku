...
<body>
    <div class="container-fluid">
        ...
        <tr>
                ...
                <td><?= $data->lokasi ?></td>
                <td><?= $data->jumlah ?></td>
                <td><a class="bg-primary btn btn-primary" href="pinjam_buku.php?id_buku=<?=$data->id_buku ?>">Pinjam</a>
                <a class="bg-success btn btn-success" href="edit_buku.php?id_buku=<?=$data->id_buku ?>">Edit</a>
                <a class="bg-danger btn btn-danger" href="hapus_buku.php?id_buku=<?=$data->id_buku ?>">Hapus</a> </td>
        ...
        <div class="sidebar-menu">
            ...
            <div class="menu">
                <ul id="menu">
                    ...
                    <li id="menu-academico"><a href="lihat_peminjaman.php"><i
