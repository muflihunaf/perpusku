            ...
            <div class="right_col" role="main">
                ...
                while ($data = mysqli_fetch_object($query)) {?>
                        <tr>
                            ...
                            <td><?= $data->lokasi ?></td>
                            <td><?= $data->jumlah ?></td>
                            <td><a class="bg-primary btn btn-primary"
                                    href="pinjam_buku.php?id_buku=<?=$data->id_buku ?>">Pinjam</a>
                                <a class="bg-success btn btn-success"
                                    href="edit_buku.php?id_buku=<?=$data->id_buku ?>">Edit</a>
                                <a class="bg-danger btn btn-danger"
                                    href="hapus_buku.php?id_buku=<?=$data->id_buku ?>">Hapus</a> </td>
