                    ...
                    <input type="hidden" name="id_peminjaman" value="<?= $data->id_peminjaman ?>">
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="nim" disabled value="<?= $data->nim; ?>" id="nim" required="required" class="form-control ">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="nama" disabled value="<?= $data->nama ?>" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="prodi" disabled value="<?= $data->prodi ?>" class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Tanggal Hari Ini</label>
                        <div class="col-md-6 col-sm-6 ">
                          <input class="form-control" type="date" id="datenow" name="tglsekarang" required>
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Tanggal Harus Kembali</label>
                        <div class="col-md-6 col-sm-6 ">
                          <input class="form-control" type="date" value="<?= $data->tgl_pengembalian ?>" disabled name="tglkembali" required>
                        </div>
                      </div>
                      <div class="item form-group">
