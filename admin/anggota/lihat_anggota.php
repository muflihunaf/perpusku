                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                ...
                                <li><a href="lihat_anggota.php"><i class="fa fa-users"></i> Anggota </a>
                                </li>
                                ...
                                <?php
                                    ...
                                    $l = $data->fetch_object();
                                ?>
                                <li><a href="ganti_password.php?id_user=<?= $l->id_user ?>"><i class="fa fa-lock"></i> Ganti Password </a>
                                </li>
                            </ul>
                        </div>
                ...
                while ($data = mysqli_fetch_object($query)) {?>
                                                        <tr>
                                                            ...
                                                            <td><a class="btn btn-primary"
                                                                    href="edit_anggota.php?id_anggota=<?=$data->id_anggota ?>">Edit</a>
                                                                <a class="bg-danger btn btn-primary" id="id_anggota"
                                                                    onclick="hapus()"
                                                                    href="hapus_anggota.php?id_anggota=<?=$data->id_anggota ?>">Hapus</a>
                                                            </td>
